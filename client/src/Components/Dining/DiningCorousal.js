...
import PictureCarousalCard from '../PictureCarousal';
    ...
    const settings = {
      ...
      const DiningSm = () => {
        return(
            <>
              <div className="flex items-center justify-between border-b-2 pb-2 w-full h-full border-gray-100">
              ...
              <div className="flex overflow-scroll justify-evenly gap-1 mb-5">
              
              {categories.map((image) => (<PictureCarousalCard {...image} />))}
