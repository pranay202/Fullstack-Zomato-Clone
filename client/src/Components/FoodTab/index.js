...
/*     useEffect(() => {
    ...
    return (
        <>
        <div className="lg:hidden bg-white shadow-4xl p-3 px-8 fixed bottom-0 z-10 w-full flex items-center justify-between md:justify-evenly text-gray-500 border">  
        {
            allTypes.map((items) => (
